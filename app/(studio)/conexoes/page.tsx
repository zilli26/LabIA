    ...
    <main className="mx-auto w-full max-w-6xl flex-1 px-5 py-8">
      <div className="mb-8">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-lab-text-dim">
          Gerencie autenticação pessoal por provider. O executor roda separado do worker de geração e o estado de capacidade permanece independente do estado da conta.
        </p>
      </div>
